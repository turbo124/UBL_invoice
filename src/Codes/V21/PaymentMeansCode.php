...
class PaymentMeansCode
{
    ...
    public const ACH_DEMAND_CASH_CONCENTRATION_DISBURSEMENT_CCD_CREDIT  = '17';
    public const ACH_DEMAND_CASH_CONCENTRATION_DISBURSEMENT_CCD_DEBIT  = '18';
    public const ACH_DEMAND_CORPORATE_TRADE_PAYMENT_CTP_CREDIT  = '19';
    ...
    public const ACH_DEMAND_CORPORATE_TRADE_PAYMENT_CTP_DEBIT  = '27';
    public const ACH_DEMAND_CORPORATE_TRADE_EXCHANGE_CTX_CREDIT  = '28';
    public const ACH_DEMAND_CORPORATE_TRADE_EXCHANGE_CTX_DEBIT  = '29';
    public const CREDIT_TRANSFER  = '30';
    public const DEBIT_TRANSFER  = '31';
    public const ACH_DEMAND_CASH_CONCENTRATION_DISBURSEMENT_PLUS_CCD_CREDIT  = '32';
    public const ACH_DEMAND_CASH_CONCENTRATION_DISBURSEMENT_PLUS_CCD_DEBIT  = '33';
    public const ACH_PREARRANGED_PAYMENT_AND_DEPOSIT_PPD  = '34';
    public const ACH_SAVINGS_CASH_CONCENTRATION_DISBURSEMENT_CCD_CREDIT  = '35';
    public const ACH_SAVINGS_CASH_CONCENTRATION_DISBURSEMENT_CCD_DEBIT  = '36';
    public const ACH_SAVINGS_CORPORATE_TRADE_PAYMENT_CTP_CREDIT  = '37';
    public const ACH_SAVINGS_CORPORATE_TRADE_PAYMENT_CTP_DEBIT  = '38';
    public const ACH_SAVINGS_CORPORATE_TRADE_EXCHANGE_CTX_CREDIT  = '39';
    public const ACH_SAVINGS_CORPORATE_TRADE_EXCHANGE_CTX_DEBIT  = '40';
    public const ACH_SAVINGS_CASH_CONCENTRATION_DISBURSEMENT_PLUS_CCD_CREDIT  = '41';
    public const PAYMENT_TO_BANK_ACCOUNT  = '42';
    public const ACH_SAVINGS_CASH_CONCENTRATION_DISBURSEMENT_PLUS_CCD_DEBIT  = '43';
    ...
    public const FR_NORME_6_97_TELEREGLEMENT_CFONB_FRENCH_ORGANISATION_FOR_BANKING_STANDARDS____OPTION_A  = '51';
